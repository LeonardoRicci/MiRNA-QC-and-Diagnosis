...
qualityThresholdAlpha <- miRNA_assessQualityThreshold(preprocessedDatasetAlpha, significanceLevel=0.05, outputFileName="qualityThreshold_datasetAlpha.dat")
...
statisticsAlpha <- miRNA_classifierSetup(purifiedDatasetAlpha, inputTargetList=Target, inputVersusList=Versus, outputFileBasename="mirnaAnalysis_datasetAlpha")
# The same as the last call, but using "FZ" as normalizer.
statisticsAlphaNorm <- miRNA_classifierSetup(purifiedDatasetAlpha, inputTargetList=Target, inputVersusList=Versus, inputMiRNAList=c("FZ"), outputFileBasename="mirnaAnalysisNorm_datasetAlpha")
...
thresholdValues <- miRNA_classifierSetup(purifiedDatasetAlpha, inputTargetList=Target, inputVersusList=Versus, inputMiRNAList=mirnaToUse, coeffList=coefficientsToUse, outputFileBasename="threshold_datasetAlpha")
...
diagnosedBeta <- miRNA_diagnosis(purifiedDatasetBeta, inputMiRNAList=mirnaToUse, coeffList=coefficientsToUse, inputThreshold=thresholdValues, outputFileBasename="diagnosis_datasetBeta")
